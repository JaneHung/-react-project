...
/******/ 	var hotCurrentHash = "98056a6467a11c08db1a"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerConfig = __webpack_require__(169);
	...
	_reactDom2.default.render(_routerConfig2.default, document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomeView = __webpack_require__(258);

	var _HomeView2 = _interopRequireDefault(_HomeView);

	var _productBox = __webpack_require__(261);
	...
	var RouterConfig = _react2.default.createElement(
		_reactRedux.Provider,
		{ store: store, key: 'provider' },
		_react2.default.createElement(
			_reactRouter.Router,
			{ history: _reactRouter.hashHistory },
			_react2.default.createElement(_reactRouter.Route, { path: '/', component: _productBox2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: '/home', component: _HomeView2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: '/demo/test01', component: _test2.default }),
			_react2.default.createElement(_reactRouter.Route, { path: '/demo/test02', component: _test4.default })
		)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(238)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//叠加一些中间件
	var createStoreWithMiddleware = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), (0, _redux.applyMiddleware)((0, _reduxLogger2.default)()))(_redux.createStore);

	//加载reducers
	function configureStore(initialState) {
	  var store = createStoreWithMiddleware(_reducers2.default, initialState); // 初始化创建
	  if (true) {
	    module.hot.accept(252, function () {
	      var nextReducer = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _models = __webpack_require__(253);

	var reducers = _interopRequireWildcard(_models);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	var combine = (0, _redux.combineReducers)(reducers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createReducer2 = __webpack_require__(255);
	...
	var Home = (0, _createReducer3.default)(inintailState, (_createReducer = {}, _defineProperty(_createReducer, 'SET', function SET(state, action) {
		return {
			name: action.name,
			vipNumb: action.vipNumb,
			mileage: action.mileage
		};
	}), _defineProperty(_createReducer, 'DEL', function DEL(state, action) {
		return {
			name: 'none',
			vipNumb: 'none',
			mileage: 'none'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomeView = _react2.default.createClass({
		...
		setInfo: function setInfo() {
			this.props.dispatch((0, _index.setInfo)('ken', '1101110110', '9000'));
		},
		delInfo: function delInfo() {
			this.props.dispatch((0, _index.delInfo)());
		},
		test: function test() {
			this.props.dispatch((0, _index.links)(1));
			console.log(this.props.Links.url);
		},
		render: function render() {
			var _this = this;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('span', { className: 'menu' }),
						_react2.default.createElement(
							'span',
							null,
							'HNA'
						),
						_react2.default.createElement('span', { className: 'phone' })
					),
					_react2.default.createElement(
						'section',
						{ className: 'info row' },
						_react2.default.createElement('span', { className: 'head-img' }),
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'row business-item' },
							_react2.default.createElement(
								'span',
								{ onClick: this.setInfo, className: 'book-ticket' },
								'预定机票'
							),
							_react2.default.createElement(
								'span',
								{ onClick: this.delInfo, className: 'vip-server' },
								'会员服务'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{ onClick: function onClick() {
										return _this.props.dispatch((0, _index.links)(1));
									}, className: 'check-in', href: this.props.Links.url },
								'办理值机'
							),
							_react2.default.createElement(
								'a',
								{ onClick: function onClick() {
										return _this.props.dispatch((0, _index.links)(2));
									}, className: 'change-data', href: this.props.Links.url },
								'改期'
							)
						)
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setInfo(name, vipNumb, mileage) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductBox;
	ProductBox = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestView1 = _react2.default.createClass({
		displayName: 'TestView1',

		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'test01' },
				'test01View test01View',
				_react2.default.createElement('br', null)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestView2 = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'test01' },
				'2222222222View te2222222222222222View',
				_react2.default.createElement('br', null)
			);
		}
	});
	module.exports = TestView2;
